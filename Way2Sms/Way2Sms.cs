...
namespace Way2SmsApp.Way2Sms
{
    ...
    public class Way2SmsAPI
	{
        ...
        public void Login()
        {
            ...
            if (!string.IsNullOrEmpty(response))
            {
                Logger.LogIt("Way2Sms login successful");
                IsLoggedIn = true;
            }
            else
            {
                Logger.LogIt("Way2Sms login failed");
            }
        ...
        public bool SendSms(string mobileNum, string msg)
        {
            int retryCnt = 0;
